...
.. code-block:: python
  ...
  SERVING_NAME="mnist"
  serving.create_or_update(model_path, "mnist", model_server="TENSORFLOW_SERVING", model_version=1)
  ...
  serving.create_or_update(script_path, "irisClassifier", model_server="FLASK", model_version=1)
